...
namespace il2cpp
{
    ...
    bool (*Blizzard_T5_Core_Map_int_SharedPlayerInfo_ContainsKey)(Blizzard_T5_Core_Map_int__SharedPlayerInfo__o* _this, int key, const MethodInfo* method);
    SharedPlayerInfo_o* (*Blizzard_T5_Core_Map_int_SharedPlayerInfo_get_Item)(Blizzard_T5_Core_Map_int__SharedPlayerInfo__o* _this, int key, const MethodInfo* method);
